      ...
      <div class="container marginbot-50">
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
              <div class="section-heading text-center"><img src="index/img/dummy/s6.jpg" class="img-responsive" alt="" /><br>
                <h2 class="h-bold">Oncologia</h2>
                <p>La oncología es la especialidad de la medicina veterinaria dedicada al estudio, diagnóstico y tratamiento del cáncer en animales.
                El aumento de la esperanza de vida en nuestras mascotas, debido a una mejor alimentación, medicina preventiva y cuidados en general, hace que estos procesos sean cada vez más comúnmente diagnosticados.
                Las causas de aparición del cáncer son multifactoriales, al igual que ocurre en las personas, y están implicados factores genéticos, nutricionales y ambientales.
                El cáncer en perros y gatos se caracteriza por un crecimiento anormal de las células, pudiendo afectar no sólo al órgano donde se inicia si no también extenderse a otros. Durante ese crecimiento anormal, las células que deberían morir de forma natural para ser sustituidas por las nuevas, no lo hacen. Las células adicionales tienden a reproducirse constantemente y pueden formar masas a las que se les da el nombre de tumores. No todos los tumores son sólidos ya que por ejemplo, la leucemia es un tipo de cáncer que se produce en la sangre.</p>
              </div>
